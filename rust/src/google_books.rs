...
fn merge_bmd(
    ...
    bmd1: crate::api::api::BookMetaDataFromProvider,
    bmd2: crate::api::api::BookMetaDataFromProvider,
...
mod tests {
    ...
    fn get_book_metadata_from_isbn_9782266162777() {
        ...
        assert_eq!(md, Some(BookMetaDataFromProvider {
            ...
            authors: vec![crate::api::api::Author{first_name: "".to_owned(), last_name: "Pamela Ball".to_owned()}],
